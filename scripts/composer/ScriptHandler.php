...
class ScriptHandler {
   ...
   * {@inheritdoc}
   */
  public static function installPreCommitHook(Event $event) : void {
    $filesystem = new Filesystem();
    $filesystem->copy('scripts/pre-commit', '.git/hooks/pre-commit');
    $filesystem->chmod('.git/hooks/pre-commit', 0755);
    $event->getIO()->write("pre-commit hook added");
  }
